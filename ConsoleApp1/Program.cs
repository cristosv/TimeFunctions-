...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Local Time {0} Max_FDP: {1}, Max_Block: {2}", originalTime, max_fdp_LocalTime, max_block_LocalTime);
            Console.WriteLine("Herb Time {0} Max_FDP: {1}, Max_Block: {2}", stationTime, max_fdp_HerbTime, max_block_HerbTime);
